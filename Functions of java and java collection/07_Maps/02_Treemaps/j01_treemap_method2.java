...
public class j01_treemap_method2 {
    public static void main(String[] args) {
        ...
        // returns the key-value pair corresponding to higher key and prints the associated value
        System.out.println(t.higherEntry(10).getValue());

        // returns the key-value pair corresponding to lower key prints the associated value
        System.out.println(t.lowerEntry(10).getValue());

        // returns a key-value mapping associated with the greatest key <= to the given key
